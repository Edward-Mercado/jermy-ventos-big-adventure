<template>
    <div class="h-24 w-full rounded-lg bg-slate-700 py-1 px-2 gap-5 flex flex-row items-center justify-between">
        <div class="h-[90%] aspect-square bg-sky-200 rounded-full overflow-hidden flex items-center justify-center">
            <img src="/images/noure.png" alt="" class="bottom-0 min-h-full w-auto">
        </div>
        <div class="flex flex-col w-[30%]">
            <div class="w-full flex flex-row items-center gap-px">
                <h5 class="pixfont text-sky-200 uppercase xl:text-xl text-md">Noure⋅</h5>
                <p class="dialogue-font text-white italic uppercase xl:text-lg text-sm">20 Mana</p>
            </div>
            <p class="pixfont xl:text-[0.9rem] text-white">Multi Hit</p>
        </div>
        <div class="w-[35%]">
            <p class="dialogue-font text-[0.8rem]">Attack 4 times for decreasing damage.</p>
        </div>
