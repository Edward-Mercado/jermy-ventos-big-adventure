...
>
        ...
        <p class="absolute w-full h-full flex p-1.5 font-extrabold dialogue-font lg:text-xl md:text-md text-xs" :class="textClass">{{ prop.isEXP ? `To LV. ${prop.nextLevel}:  ` : '' }} {{ displayedHP }} / {{ maxHP }}</p>
    </div>
    </div>
</template>
