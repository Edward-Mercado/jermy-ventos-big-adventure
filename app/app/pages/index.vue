<template>
    <div class="bg-slate-400 h-dvh p-5 items-center flex flex-col">
        <h1 class="text-[4rem] text-black pixfont text-center font-extrabold shaky mt-12 select-none">WELCOME TO JERMYVENTO'S BIG
            ADVENTURE!</h1>
    ...
    <p class="fixed text-lg dialogue-font text-white bottom-2 left-2 italic">Please play the game in widescreen (something like 1280x720) for a better viewing experience. </p>
</template>
