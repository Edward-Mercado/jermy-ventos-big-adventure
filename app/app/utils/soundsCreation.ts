...
const blockyball = new Howl({ src: ['/sounds/blockyball.m4a'], volume: 0.8, preload: true })
const noure = new Howl({ src: ['/sounds/noure.m4a'], volume: 0.8, preload: true })
const humd = new Howl({ src: ['/sounds/humd.m4a'], volume: 0.8, preload: true })
const lemonalien = new Howl({ src: ['/sounds/lemonalien.m4a'], volume: 0.8, preload: true })
const kortnee = new Howl({ src: ['/sounds/kortnee.m4a'], volume: 0.8, preload: true })
...
const alastor = new Howl({ src: ['/sounds/alastor.m4a'], volume: 0.8, preload: true })
...
const rtgame = new Howl({ src: ['/sounds/rtgame.m4a'], volume: 0.8, preload: true })
...
const columbo = new Howl({ src: ['/sounds/columbo.m4a'], volume: 0.8, preload: true })
const pierce = new Howl({ src: ['/sounds/pierce.m4a'], volume: 0.8, preload: true })
